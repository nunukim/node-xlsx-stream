...
module.exports = {
  ...
  sheet_related: {
    ...
    "xl/_rels/workbook.xml.rels": {
      ...
      sheet: function(sheet) {
        return "<Relationship Id=\"rId" + (esc(sheet.index)) + "\" Type=\"http://schemas.openxmlformats.org/officeDocument/2006/relationships/worksheet\" Target=\"" + (esc(sheet.rel)) + "\"/>";
      },
    ...
    "xl/workbook.xml": {
      ...
      sheet: function(sheet) {
        return xml("<sheet name=\"" + (esc(sheet.name)) + "\" sheetId=\"" + (esc(sheet.index)) + "\" r:id=\"rId" + (esc(sheet.index)) + "\"/>");
      },
